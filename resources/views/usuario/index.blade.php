    ...
    <div class="col-md-4">
        ...
        <div class=text-right>
          <a href="{{ route('novo-usuario') }}" >
            <button type="button" class="btn btn-primary">Novo Usuario</button
            ></a>
        </div>
    </div>
</div>
        ...
        <table class="table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            <tr >
              ...
              <td>{{ $usuario->email }}</td>
              <td><a class="btn btn-primary"  href="{{ route('edita-usuario',$usuario->id) }}"  ><i class="fa fa-lg fa-edit"
                    title="Editar"></i></a></td>              
              <td>
                <form action="{{ route('deleta-usuario',$usuario->id) }}" method="POST">  
                @csrf
                @method('DELETE')
