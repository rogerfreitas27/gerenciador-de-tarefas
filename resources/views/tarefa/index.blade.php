                        ...
                        @can('access-menu-usuario')
                            <div class=text-right>
                                <a href="{{ route('cadastro-tarefa') }}">
                                    <button type="button" class="btn btn-primary">Nova Tarefa</button></a>
                            </div>
                        @endcan
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($tarefas as $tarefa)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary" href="{{ route('edita-tarefa', $tarefa->id) }}"><i
                                        ...
                                        @can('access-menu-usuario')
                                            ...
                                            <td> <a class="btn btn-success"
                                                    href="{{ route('view-tarefaAddDev', $tarefa->id) }}"> <i
                                                        class="fa fa-lg fa-plus" title="Deletar"></i></a> </td>




                                            <td> <a class="btn btn-danger"
                                                    href="{{ route('view-tarefaRemoveDev', $tarefa->id) }}"> <i
                                                        class="fa fa-lg fa-minus" title="Deletar"></i></a> </td>
                                        @endcan
                                    </tr>
                                @endforeach
