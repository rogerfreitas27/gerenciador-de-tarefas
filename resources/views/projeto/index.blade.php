                    ...
                    @can('access-menu-usuario')
                        <div class=text-right>
                            <a href="{{ route('cadastro-projeto') }}">
                                <button type="button" class="btn btn-primary">Novo Projeto</button></a>
                        </div>
                    @endcan
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach ($projetos as $projeto)
                                <tr>
                                    ...
                                    <td>{{ $projeto->nome }}</td>
                                    <td><progress value="{{ $projeto->Qtd_tarefas_concluidas }}"
                                            max="{{ $projeto->Qtd_tarefas }}"></progress></td>
                                    @can('access-menu-usuario')
                                        <td>
                                            <a class="btn btn-primary" href="{{ route('edita-projeto', $projeto->id) }}"><i
                                                    class="fa fa-lg fa-edit" title="Editar"></i></a>
                                        </td>
                                        <td>
